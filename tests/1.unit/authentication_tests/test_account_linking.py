#!/usr/bin/env python3
"""
#exonware/xwauth/tests/1.unit/authentication_tests/test_account_linking.py
...
import pytest
from exonware.xwlogin.auth_connector import XWUserError
from exonware.xwlogin.authentication.account_linking import AccountLinking
from exonware.xwlogin.test_support import MockUser, XWAuth, XWAuthConfig
