#!/usr/bin/env python3
"""
#exonware/xwauth/tests/1.unit/providers_tests/test_provider_registry.py
...
import pytest
from exonware.xwlogin.provider_connector import ProviderRegistry, XWProviderNotFoundError
