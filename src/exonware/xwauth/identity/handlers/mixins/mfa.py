# exonware/xwauth.identity/handlers/mixins/mfa.py
...
from exonware.xwauth.identity.authentication.mfa_webauthn_audit import audit_mfa_event

from exonware.xwauth.identity.handlers._common import MFA_TAGS, get_auth, get_bearer_token, get_current_user_id, get_user_lifecycle
...
from exonware.xwauth.identity.security.mfa_policy import merge_amr_claims, require_backup_codes
