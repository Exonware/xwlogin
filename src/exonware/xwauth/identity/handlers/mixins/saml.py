# exonware/xwauth.identity/handlers/mixins/saml.py
...
from exonware.xwauth.identity.handlers._common import SSO_TAGS, get_auth, get_saml_manager, get_user_lifecycle
