...
#exonware/xwauth.identity/src/exonware/xwauth.identity/authentication/account_linking.py
...
from exonware.xwauth.identity.errors import XWUserAlreadyExistsError, XWUserError
